...
<body>
    ...
    <h1 class="title_for_signup_login_page">Welcome once again To Amigram</h1>
    <div class="form_container">
        <div>
            ...
            <p class="redirect-to-login-signup-page">Create a new account. <a href="signup.php">Sign up</a></p>
        </div>
    </div>
